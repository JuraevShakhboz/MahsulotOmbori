...
<body>
<form id="myForm" action="<%= request.getContextPath()%>/submitupdatemaxsulot/<%= maxsulot.getId()%>">
  <div class="mb-3">
    <label for="name" class="form-label">Name</label>
    <input type="text"  id="name" name="name" placeholder="<%= maxsulot.getNomi()%>">
  </div>
  <div class="mb-3">
    <label for="price" class="form-label">Price</label>
    <input type="number"  id="price" name="price" placeholder="<%= maxsulot.getNarxi()%>">
  </div>
